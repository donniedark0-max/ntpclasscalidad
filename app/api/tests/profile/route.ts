...
export async function GET() {
  console.log('🚀 Iniciando prueba de edición de perfil (Selector de Dirección Corregido)...');
  ...
  try {
    ...
    // ⭐ CAMBIO CLAVE: Se corrige el aria-label para que coincida con el del formulario.
